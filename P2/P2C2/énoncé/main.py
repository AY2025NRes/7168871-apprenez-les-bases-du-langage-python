...
for nombre in liste : 
    if int(nombre) > moyenne: # CORRECTION : remplacer nombre par str(nombre)!!!!!!!!!!!
        nombre_au_dessus_moyenne += 1
print("Nombre de nombres supérieurs à la moyenne:", nombre_au_dessus_moyenne)# Ecrivez votre code ici !
